            ...
            if (
                ...
                if parsed_agent.compile_in_return:
                    ...
                    if match:
                        ...
                        changes.append("Modified return compile() to register with ArbiterOS")
                        offset += 6
                else:
                ...
                try:
                    ...
                    if (
                        ...
                        if not has_os_import:
                            ...
                            source_lines.insert(import_end + 1, "# Import ArbiterOS governance - call get_arbiter_os() dynamically, not at module import")
